<template>
    <div>
        ...
        <form class="mb-3" @submit.prevent="addArticle">
            ...
            <button type="submit" class="btn badge-info"> Save</button>
        </form>
        ...
        <div class="card card-body mb-2" v-for="article in articles" v-bind:key="article.id">
            ...
            <hr>
            <div class="row">
                <button @click="editArticle(article)" class="btn btn-warning col-2 m-1">Edit</button>
                <button @click="deleteArticle(article.id)" class="btn btn-danger col-2 m-1">Delete</button>
            </div>
        </div>
    </div>
</template>
